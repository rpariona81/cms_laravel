...
class UsuarioController extends Controller
{
    ...
    public function __construct()
    {
         ...
         * de modo que sea necesario estar autenticado
         */
    ...
    /**
     * Guardar un nuevo elemento en la BD
     * 
    ...
    /**
     * Actualizar un elemento en la BD
     * 
     * @param \App\Http\Requests\UsuarioRequest $request
     * @param int $id
     * @return \Illuminate\Http\Response
    ...
    public function actualizar(UsuarioRequest $request, $id)
    {
        ...
        return redirect('admin/usuarios')->with('success', 'Usuario <strong>'.$request->nombre.'</strong> actualizado.');
    }
